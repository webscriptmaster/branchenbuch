 ...
 * @version    CVS: $Id: TagCloud.php,v 1.1 2007/07/23 09:48:29 matthias Exp $
...
class HTML_TagCloud {
	...
	function HTML_TagCloud($baseFontSize = 24, $fontSizeRange = 12) {
		$this->__construct($baseFontSize, $fontSizeRange);
	}
    ...
    */
    function _buidHTMLTags($param)
    {
        ...
        // Edited by koyote44 on 18.06.2007
        if(isset($param['sort'])) $this->_sortTags($limit);
        $this->_calcMumCount();
        $this->_calcMumEpoc();
